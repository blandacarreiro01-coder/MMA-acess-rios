...
def dar_baixa_produto(nome, quantidade_baixa):
    """
    Abate uma quantidade do estoque de um produto existente.

    Se a quantidade em estoque chegar a 0 (ou menos, o que não
    deveria acontecer pois o Controller valida antes), o produto
    é removido por completo do catálogo.

    Retorna uma tupla (sucesso, motivo):
        sucesso -> True ou False
        motivo  -> "ok", "nao_encontrado" ou "quantidade_insuficiente"
    """

...
from view_texto.comprar_view_texto import tela_registrar_compra
from view_texto.atualizar_estoque_view_texto import tela_atualizar_estoque
...
def main():
    ...
    while True:
        ...
        if not autenticado:
            ...
            """
            Usando 'continue' para reiniciar o loop a partir desse ponto.
        ...
        if opcao == "1":
            ...
            exibir_cabecalho()
            tela_registrar_compra()

        elif opcao == "6":
            exibir_cabecalho()
            tela_atualizar_estoque()
